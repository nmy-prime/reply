...
public class FabricItems {
    ...
    private static final Item BAKED_BREAD = new Item(new Item.Settings()
            .group(Main.MY_GROUP)
    ...
    private static final Item LONG_QUAN_SWORD_SOUL = new Item(new FabricItemSettings().group(Main.MY_GROUP).maxCount(1));


    public static void register() {
        ReplyArmorMaterial.register();
        ReplyMaterial.register();
        Registry.register(Registry.ITEM, new Identifier(Main.ModId, "long_quan_sword_soul"), LONG_QUAN_SWORD_SOUL);
